...
describe('URI Parser', function () {
    ...
    describe('parseUri + mapUriDefaultScheme', function () {
        ...
        for (const { target, result } of expectationList) {
            it(target, function () {
                var _a;
                assert.deepStrictEqual(resolver.mapUriDefaultScheme((_a = uriParser.parseUri(target)) !== null && _a !== void 0 ? _a : { path: 'null' }), result);
            });
        }
    });
...
//# sourceMappingURL=test-uri-parser.js.map